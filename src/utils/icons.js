...
export const RightArrowIcon = ({ fill, size }) => {
    ...
    return (
        ...
        >
            ...
            <path d="M289.5 256L142.87 402.63a16 16 0 0 0 0 22.63l22.63 22.63a16 16 0 0 0 22.63 0L343 293.06a16.23 16.23 0 0 0 3.57-2.67l22.62-22.63a17.14 17.14 0 0 0 0-23.52l-22.62-22.63a16.23 16.23 0 0 0-3.57-2.67L188.13 64.11a16 16 0 0 0-22.63 0l-22.63 22.63a16 16 0 0 0 0 22.63z" fill={iconFill} />
        </svg>
    );
}
...
export const LeftArrowIcon = ({ fill, size }) => {
    ...
    return (
        ...
        >
            ...
            <path d="M222.5 256l146.63-146.63a16 16 0 0 0 0-22.63L346.5 64.11a16 16 0 0 0-22.63 0L169.05 218.94a16.23 16.23 0 0 0-3.57 2.67l-22.62 22.63a17.14 17.14 0 0 0 0 23.52l22.62 22.63a16.23 16.23 0 0 0 3.57 2.67l154.82 154.83a16 16 0 0 0 22.63 0l22.63-22.63a16 16 0 0 0 0-22.63z" fill={iconFill}/>
        </svg>
    );
}
