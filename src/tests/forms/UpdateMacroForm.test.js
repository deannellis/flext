...
test('clicking cancel should close form', async () => {
	...
	const { getByText } = render(
		<UpdateMacroForm closeForm={closeForm} updateMacro={defaultUpdateMacro} />
	);
