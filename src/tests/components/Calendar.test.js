...
test("should link to workout by date", () => {
	...
	const wrapper = shallow(<Calendar onClickWorkoutDate={onClickWorkoutDate}  workouts={workouts} />);

	wrapper.find('.calendar__day--worked-out').simulate('click');
	expect(onClickWorkoutDate).toHaveBeenCalledWith('1d8ad17a-c62a-4182-8ddb-0df62af33c65');
});
